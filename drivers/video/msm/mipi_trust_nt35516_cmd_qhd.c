...
static int __init mipi_cmd_trust_nt35516_qhd_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_cmd_trust_nt35516_qhd"))
		return 0;
	...
	pinfo.bl_max = MIPI_TRUST_NT35516_PWM_LEVEL;
	pinfo.bl_min = 1;
	pinfo.fb_num = 2;
	//pinfo.clk_rate = 499000000; // use auto-calculation by driver
	...
	ret = mipi_trust_nt35516_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_cmd_trust_nt35516_qhd_init);
