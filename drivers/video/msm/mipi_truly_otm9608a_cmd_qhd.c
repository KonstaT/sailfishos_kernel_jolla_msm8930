...
static int __init mipi_cmd_truly_otm9608a_qhd_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_cmd_truly_otm9608a_qhd"))
		return 0;
	...
	pinfo.bl_min = 1;
	pinfo.fb_num = 2;
	//pinfo.clk_rate = 454000000; // use auto-calculation by driver
...
module_init(mipi_cmd_truly_otm9608a_qhd_init);
