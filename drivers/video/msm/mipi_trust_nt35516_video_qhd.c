...
static int __init mipi_video_trust_nt35516_qhd_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_trust_nt35516_qhd"))
		return 0;
...
module_init(mipi_video_trust_nt35516_qhd_init);
